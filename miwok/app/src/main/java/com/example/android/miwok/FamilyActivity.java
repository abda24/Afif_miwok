...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("father", "ayah", R.drawable.family_father, R.raw.ayah));
        words.add(new Word("mother", "ibu", R.drawable.family_mother, R.raw.ibu));
        words.add(new Word("son", "anak", R.drawable.family_son, R.raw.anak));
        words.add(new Word("daughter", "saudara", R.drawable.family_daughter, R.raw.saudara));
        words.add(new Word("older brother", "kakak", R.drawable.family_older_brother,
                R.raw.kakak));
